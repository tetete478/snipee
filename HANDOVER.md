...
| 問題                            | 原因             | 解決策                                  |
| ------------------------------- | ---------------- | --------------------------------------- |
| GitHub Actions が起動しない     | タグ形式が不正   | `v` で始まるタグを使う（例: `v1.5.12`） |
...
### Phase 2: 自動ペースト・変数機能（完了 - v1.5.12）
...
**Phase 2 完了日**: 2025-11-28（v1.5.12）
